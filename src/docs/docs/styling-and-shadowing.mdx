...
The libraries used to style Chicago Docs components were chosen to make the site easy to customize for the largest number of users. You can re-style components using plain CSS or SASS. You can also style and customize components directly using Theme-UI or JavaScript.
...
The new file you create should live in your site's `src` folder, in a directory with the same name as the theme you're shadowing. For example, to shadow the Chicago Docs <a href="/docs/components-and-hooks/#alert">Alert</a> component, which has a file path of `@kabartolo/gatsby-theme-chicago-docs/src/components/Alert/index.js`, create the following folder structure in your site:
